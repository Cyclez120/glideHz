...
function onFastTick() {
    ...
    if (Data.getBoolean("glide-loaded", false) && module != null && mode != null && velocity != null && module.isActive()) { // проверки на null нужны потому что onFastTick начинает работу раньше чем module, mode и velocity инициализируются
